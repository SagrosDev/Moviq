...
- Use the pinned stack: Python 3.14.6, Django 5.2.15 LTS, DRF 3.17.1, Psycopg 3.3.4, drf-spectacular 0.30.0, PostgreSQL 17.10, Node.js 26.6.0, TypeScript 6.0.x, React 19.2.7, Vite 8.2.x, React Flow 12.11.2, ClamAV 1.5.3, pytest 9.1.1, and Playwright 1.62.x.
