...
- Story 1.2 established the static React/Vite SPA under `Moviqo.Front/`, feature-sliced architecture checks, one query layer, reducer-based draft primitives, Playwright smoke coverage, and Node 26.7.0 enforcement. Do not weaken the Node guard or introduce a frontend server.
